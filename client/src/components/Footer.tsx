      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            <Link href="/">
              <a className="text-xl font-heading font-bold text-white mb-4 inline-block">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/destinations">
                  <a className="text-white/80 hover:text-accent transition-colors">Destinations</a>
                </Link>
              </li>
              <li>
                <Link href="/how-it-works">
                  <a className="text-white/80 hover:text-accent transition-colors">How It Works</a>
                </Link>
              </li>
              <li>
                <Link href="/about">
                  <a className="text-white/80 hover:text-accent transition-colors">About Me</a>
                </Link>
              </li>
              <li>
                <Link href="/contact">
